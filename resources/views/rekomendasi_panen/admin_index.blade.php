                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Riwayat Rekomendasi Panen</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach ($recommendations as $recommendation)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('rekomendasi-panen.show', $recommendation->id) }}" class="btn btn-primary btn-sm">Lihat Detail</a>
                                                <form action="{{ route('rekomendasi-panen.destroy', $recommendation->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('cetak.laporan.rekomendasi.panen') }}" method="GET" target="_blank">
                        <div class="mb-3">
