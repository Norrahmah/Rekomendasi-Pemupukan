                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('usia-cabai-tumbuh.index') }}">Data Usia Cabai
                                    Tumbuh</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Usia Cabai Tumbuh</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card border-0 border-4">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-black">Form Tambah Usia Cabai Tumbuh</h5>
                        </div>
                        <hr>
                        <form class="row g-3" action="{{ route('usia-cabai-tumbuh.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
