...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Riwayat Rekomendasi Panen</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Data Riwayat Rekomendasi Panen</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <script>
        function lihatHasil(id) {
            $.ajax({
                url: '/riwayat-rekomendasi-panen/' + id + '/hasil',
                method: 'GET',
                success: function(response) {
                    ...
                    rekomendasiHtml += `<tr><th colspan="12">Hasil Rekomendasi Pemupukan Panen</th></tr>`;
                    rekomendasiHtml +=
