            ...
            <div class="card border-0 border-4 mt-2">
                <div class="card-body p-4">
                    <div class="card-title d-flex align-items-center">
                        <h5 class="mb-0 text-black">Riwayat Rekomendasi Tumbuh</h5>
                    </div>
                    <hr>
                            ...
                            <tbody>
                                @foreach ($recommendations as $recommendation)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('rekomendasi-tumbuh.cetak', $recommendation->id) }}" target="_blank" class="btn btn-success btn-sm">Cetak</a>
