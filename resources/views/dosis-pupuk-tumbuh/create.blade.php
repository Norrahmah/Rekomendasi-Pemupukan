                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dosis-pupuk-tumbuh.index') }}">Data Dosis Pupuk
                                    Tumbuh</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Dosis Pupuk Tumbuh</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card border-0 border-4">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-black">Form Tambah Dosis Pupuk Tumbuh</h5>
                        </div>
                        <hr>
                        <form class="row g-3" action="{{ route('dosis-pupuk-tumbuh.store') }}" method="post">
                            @csrf
